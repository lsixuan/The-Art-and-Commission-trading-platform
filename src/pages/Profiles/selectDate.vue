...
<script>
import { saveArtistNoDate, deleteArtistNoDateByDate, deleteArtistNoDateByUserId, getArtistNoDateListByUserId } from '@/api/artistNoDate'
  ...
  methods: {
    async reloadData(){
      try {
        ...
        const response = await getArtistNoDateListByUserId({userId:userId});
